...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,594 | 🐛 105 | 📅 2026-09-02
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,052 | 🐛 88 | 🌐 Python | 📅 2026-09-03: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,930 | 🐛 32 | 🌐 Java | 📅 2026-09-03: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,642 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,421 | 🐛 10 | 🌐 Python | 📅 2026-08-07: Convert your KiCAD boards into nice looking 2D drawings suitable for pinout diagrams
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 735 | 🐛 27 | 🌐 Python | 📅 2026-09-03: KiCad automation utility.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,545 | 🐛 43 | 🌐 Python | 📅 2026-09-02: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,070 | 🐛 0 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [KiCadStepUp](https://github.com/easyw/kicadStepUpMod/) ⭐ 685 | 🐛 40 | 🌐 Python | 📅 2026-08-14: KiCad StepUp is a FreeCAD Workbench to help in mechanical collaboration between KiCad EDA and FreeCAD.
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,948 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

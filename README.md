...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,483 | 🐛 105 | 📅 2026-08-21
...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 598 | 🐛 0 | 🌐 Python | 📅 2026-08-25 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 598 | 🐛 0 | 🌐 Python | 📅 2026-08-25; you rock!
...
* [KiKit](https://github.com/yaqwsx/KiKit) ⭐ 2,012 | 🐛 98 | 🌐 Python | 📅 2026-08-05: Library and CLI tool to panelize boards, export manufacturing data and build board presentation pages.
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,044 | 🐛 83 | 🌐 Python | 📅 2026-07-30: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
* [KiCost](https://github.com/xesscorp/KiCost) ⭐ 622 | 🐛 32 | 🌐 Python | 📅 2026-07-08: Build cost spreadsheet for a KiCad project.
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,913 | 🐛 40 | 🌐 Java | 📅 2026-08-27: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,637 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiCad Templates](https://github.com/sethhillbrand/kicad_templates) ⭐ 760 | 🐛 6 | 🌐 HTML | 📅 2019-10-24: Provides a number of additional Board and production house templates for KiCad EDA.
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 734 | 🐛 27 | 🌐 Python | 📅 2026-08-27: KiCad automation utility.
* [uConfig](https://github.com/Robotips/uConfig) ⭐ 585 | 🐛 29 | 🌐 C++ | 📅 2026-02-24: Datasheet pinout extractor from PDF and library Stylizer for Kicad.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,533 | 🐛 42 | 🌐 Python | 📅 2026-07-12: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,031 | 🐛 4 | 🌐 Python | 📅 2026-08-20: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-08-20: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [BoardRepo](https://github.com/flintt-dev/boardrepo-plugin) ⭐ 1 | 🐛 0 | 📅 2026-08-25: Hosted project library and read-only review tools for KiCad schematics, BOMs, source files, DRC/ERC results, and fabrication constraints through MCP.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,941 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

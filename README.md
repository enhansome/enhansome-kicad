...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,042 | 🐛 106 | 📅 2026-08-21
...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 596 | 🐛 0 | 🌐 Python | 📅 2026-08-25 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 596 | 🐛 0 | 🌐 Python | 📅 2026-08-25; you rock!
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,044 | 🐛 82 | 🌐 Python | 📅 2026-07-30: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,907 | 🐛 42 | 🌐 Java | 📅 2026-08-24: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,636 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 733 | 🐛 27 | 🌐 Python | 📅 2026-08-24: KiCad automation utility.
* [uConfig](https://github.com/Robotips/uConfig) ⭐ 584 | 🐛 29 | 🌐 C++ | 📅 2026-02-24: Datasheet pinout extractor from PDF and library Stylizer for Kicad.
...
* [Circuitron](https://github.com/Shaurya-Sethi/circuitron) ⭐ 120 | 🐛 8 | 🌐 Python | 📅 2026-06-06: Agentic PCB Design Accelerator — Generate, plan, and layout circuits from natural language prompts.
* [Kobee Studio](https://github.com/mrcpuddington/kobeestudio) ⭐ 64 | 🐛 8 | 🌐 Python | 📅 2026-08-09: Modern PCB graphics toolkit for KiCad with customizable labels, icons, component overlays, QR codes, barcodes, and custom SVG assets.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,531 | 🐛 41 | 🌐 Python | 📅 2026-07-12: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,017 | 🐛 4 | 🌐 Python | 📅 2026-08-20: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,939 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

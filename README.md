...
* [KiKit](https://github.com/yaqwsx/KiKit) ⭐ 2,022 | 🐛 98 | 🌐 Python | 📅 2026-08-05: Library and CLI tool to panelize boards, export manufacturing data and build board presentation pages.
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,060 | 🐛 69 | 🌐 Python | 📅 2026-09-09: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,963 | 🐛 40 | 🌐 Java | 📅 2026-09-09: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,649 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiCad Templates](https://github.com/sethhillbrand/kicad_templates) ⭐ 768 | 🐛 6 | 🌐 HTML | 📅 2019-10-24: Provides a number of additional Board and production house templates for KiCad EDA.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,562 | 🐛 43 | 🌐 Python | 📅 2026-09-09: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,166 | 🐛 2 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [kiri](https://github.com/leoheck/kiri) ⭐ 704 | 🐛 9 | 🌐 Shell | 📅 2026-06-22: A tool for reviewing Kicad's projects visually including schematics and layout using Kicad-Diff and Plotgitsch
...
* [gerber2ems](https://github.com/antmicro/gerber2ems) ⭐ 260 | 🐛 6 | 🌐 Python | 📅 2026-04-23: Takes PCB production files as input (Gerber, drill files, stackup information) and simulates trace SI performance using openEMS
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 82 | 🐛 2 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,952 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

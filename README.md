...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,082 | 🐛 54 | 🌐 Python | 📅 2026-09-24: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 2,030 | 🐛 26 | 🌐 Java | 📅 2026-09-25: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,670 | 🐛 46 | 🌐 Python | 📅 2026-09-24: A module that extends Python with the ability to design electronic circuits.
...
* [Kobee Studio](https://github.com/mrcpuddington/kobeestudio) ⭐ 67 | 🐛 10 | 🌐 Python | 📅 2026-08-09: Modern PCB graphics toolkit for KiCad with customizable labels, icons, component overlays, QR codes, barcodes, and custom SVG assets.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,578 | 🐛 43 | 🌐 Python | 📅 2026-09-10: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,293 | 🐛 2 | 🌐 Python | 📅 2026-09-13: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
* [kicanvas](https://github.com/theacodes/kicanvas) ⭐ 1,140 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-28: KiCanvas is an interactive, browser-based viewer for KiCAD schematics and boards
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 100 | 🐛 1 | 🌐 Python | 📅 2026-09-25: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Hawk](https://github.com/MalphasWats/hawk) ⭐ 482 | 🐛 4 | 🌐 C | 📅 2020-11-06: Tutorial for making an ARM dev board in KiCAD

...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,355 | 🐛 106 | 📅 2026-09-02
...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 614 | 🐛 1 | 🌐 Python | 📅 2026-09-15 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 614 | 🐛 1 | 🌐 Python | 📅 2026-09-15; you rock!
...
* [KiKit](https://github.com/yaqwsx/KiKit) ⭐ 2,027 | 🐛 98 | 🌐 Python | 📅 2026-08-05: Library and CLI tool to panelize boards, export manufacturing data and build board presentation pages.
* [ReplicateLayout](https://github.com/MitjaNemec/ReplicateLayout) ⭐ 132 | 🐛 28 | 🌐 Python | 📅 2026-08-23: Extension to replicate the PCB layout of one hierarchical sheet to other sheets based on hierarchical sheets in Eeschema.
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,074 | 🐛 74 | 🌐 Python | 📅 2026-09-16: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [gerber\_to\_order](https://github.com/asukiaaa/gerber_to_order) ⭐ 61 | 🐛 8 | 🌐 Python | 📅 2026-09-12: A KiCad plugin to create zip compressed gerber files to order for Elecrow, FusionPCB, PCBWay or JLCPCB.
...
* [KiABOM](https://github.com/Mage-Control-Systems-Ltd/KiABOM) ⭐ 7 | 🐛 4 | 🌐 Python | 📅 2026-09-17: Simple BOM generation with online supplier data.
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,997 | 🐛 27 | 🌐 Java | 📅 2026-09-18: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,662 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,430 | 🐛 10 | 🌐 Python | 📅 2026-08-07: Convert your KiCAD boards into nice looking 2D drawings suitable for pinout diagrams
...
* [KiCad RF Tools](https://github.com/easyw/RF-tools-KiCAD) ⭐ 826 | 🐛 38 | 🌐 Python | 📅 2024-11-11: Footprints, wizards and round tracks, mask expander, via fencing
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 742 | 🐛 25 | 🌐 Python | 📅 2026-09-11: KiCad automation utility.
...
* [Import-LIB-KiCad-Plugin](https://github.com/Steffen-W/Import-LIB-KiCad-Plugin) ⭐ 257 | 🐛 7 | 🌐 Python | 📅 2026-05-01: Import KiCad component libraries imported from Ultralibrarian and SnapEDA zipfiles.
...
* [Circuitron](https://github.com/Shaurya-Sethi/circuitron) ⭐ 124 | 🐛 8 | 🌐 Python | 📅 2026-06-06: Agentic PCB Design Accelerator — Generate, plan, and layout circuits from natural language prompts.
...
* [NCCM](https://github.com/Mage-Control-Systems-Ltd/NCCM) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-05-26: Net Class Clearance Matrix (NCCM) to generate custom rules for clearances between net classes through a matrix GUI.
* [RFgen](https://github.com/NBalciunas/kicad-rfgen) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-14: KiCad plugin for quickly generating customizable RF footprints and antennas.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,569 | 🐛 43 | 🌐 Python | 📅 2026-09-10: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,252 | 🐛 2 | 🌐 Python | 📅 2026-09-13: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
* [kicanvas](https://github.com/theacodes/kicanvas) ⭐ 1,137 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-28: KiCanvas is an interactive, browser-based viewer for KiCAD schematics and boards
* [kiri](https://github.com/leoheck/kiri) ⭐ 705 | 🐛 9 | 🌐 Shell | 📅 2026-06-22: A tool for reviewing Kicad's projects visually including schematics and layout using Kicad-Diff and Plotgitsch
* [KiCadStepUp](https://github.com/easyw/kicadStepUpMod/) ⭐ 690 | 🐛 41 | 🌐 Python | 📅 2026-09-04: KiCad StepUp is a FreeCAD Workbench to help in mechanical collaboration between KiCad EDA and FreeCAD.
* [KiCad-Diff](https://github.com/Gasman2014/KiCad-Diff) ⭐ 294 | 🐛 3 | 🌐 Python | 📅 2024-06-26: Plugin to perform image diffs between pcbnew layout revisions
* [gerber2ems](https://github.com/antmicro/gerber2ems) ⭐ 259 | 🐛 7 | 🌐 Python | 📅 2026-04-23: Takes PCB production files as input (Gerber, drill files, stackup information) and simulates trace SI performance using openEMS
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 95 | 🐛 2 | 🌐 Python | 📅 2026-09-16: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [akcli](https://github.com/tipoLi5890/akcli) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-08-25: AI-native schematic design CLI for KiCad — author and edit `.kicad_sch` from JSON op-lists behind a net-diff safety gate, run ERC / design-review / BOM checks, simulate on ngspice, and source JLCPCB parts. Zero dependencies (pure-stdlib Python).
...
* [Eagle to KiCad](https://github.com/lachlanA/eagle-to-kicad) ⭐ 429 | 🐛 8 | 🌐 NASL | 📅 2022-01-03: Eagle SCH/LIB to KiCad SCH/LIB ULP conversion script

##### GUI

* [KiCad Color Schemes](https://github.com/pointhi/kicad-color-schemes) ⭐ 715 | 🐛 16 | 🌐 Python | 📅 2024-04-16

##### Other

* [kicad-wakatime](https://github.com/hackclub/kicad-wakatime) ⭐ 45 | 🐛 11 | 🌐 Rust | 📅 2026-05-28: WakaTime plugin for KiCAD 8.99

#### Symbols

* [Arduino Kicad Library](https://github.com/Alarm-Siren/arduino-kicad-library) ⭐ 447 | 🐛 13 | 📅 2025-06-07: KiCad Symbol & Footprint Library for Arduino Modules
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 154 | 🐛 0 | 🌐 Python | 📅 2026-09-17: Curated list of open source hardware projects whose PCBs are designed in KiCad.

...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 610 | 🐛 2 | 🌐 Python | 📅 2026-09-13 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 610 | 🐛 2 | 🌐 Python | 📅 2026-09-13; you rock!
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,066 | 🐛 67 | 🌐 Python | 📅 2026-09-13: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,982 | 🐛 44 | 🌐 Java | 📅 2026-09-14: Advanced PCB auto-router
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,206 | 🐛 0 | 🌐 Python | 📅 2026-09-13: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,956 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

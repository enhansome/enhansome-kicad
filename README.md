...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,057 | 🐛 90 | 🌐 Python | 📅 2026-09-06: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,951 | 🐛 34 | 🌐 Java | 📅 2026-09-04: Advanced PCB auto-router
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 737 | 🐛 27 | 🌐 Python | 📅 2026-09-04: KiCad automation utility.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,556 | 🐛 43 | 🌐 Python | 📅 2026-09-02: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,124 | 🐛 1 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,951 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

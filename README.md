...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,025 | 🐛 106 | 📅 2026-09-02
...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 603 | 🐛 0 | 🌐 Python | 📅 2026-09-11 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 603 | 🐛 0 | 🌐 Python | 📅 2026-09-11; you rock!
...
* [KiKit](https://github.com/yaqwsx/KiKit) ⭐ 2,023 | 🐛 98 | 🌐 Python | 📅 2026-08-05: Library and CLI tool to panelize boards, export manufacturing data and build board presentation pages.
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,063 | 🐛 72 | 🌐 Python | 📅 2026-09-11: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,973 | 🐛 41 | 🌐 Java | 📅 2026-09-11: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,654 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,428 | 🐛 10 | 🌐 Python | 📅 2026-08-07: Convert your KiCAD boards into nice looking 2D drawings suitable for pinout diagrams
...
* [KiCad Templates](https://github.com/sethhillbrand/kicad_templates) ⭐ 769 | 🐛 6 | 🌐 HTML | 📅 2019-10-24: Provides a number of additional Board and production house templates for KiCad EDA.
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 739 | 🐛 26 | 🌐 Python | 📅 2026-09-11: KiCad automation utility.
...
* [Import-LIB-KiCad-Plugin](https://github.com/Steffen-W/Import-LIB-KiCad-Plugin) ⭐ 254 | 🐛 6 | 🌐 Python | 📅 2026-05-01: Import KiCad component libraries imported from Ultralibrarian and SnapEDA zipfiles.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,563 | 🐛 44 | 🌐 Python | 📅 2026-09-10: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,184 | 🐛 2 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
* [kicanvas](https://github.com/theacodes/kicanvas) ⭐ 1,130 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-28: KiCanvas is an interactive, browser-based viewer for KiCAD schematics and boards
...
* [KiCadStepUp](https://github.com/easyw/kicadStepUpMod/) ⭐ 687 | 🐛 40 | 🌐 Python | 📅 2026-09-04: KiCad StepUp is a FreeCAD Workbench to help in mechanical collaboration between KiCad EDA and FreeCAD.
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 94 | 🐛 2 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Arduino Kicad Library](https://github.com/Alarm-Siren/arduino-kicad-library) ⭐ 445 | 🐛 13 | 📅 2025-06-07: KiCad Symbol & Footprint Library for Arduino Modules
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,954 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

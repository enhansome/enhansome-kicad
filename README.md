...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,161 | 🐛 106 | 📅 2026-09-02
...
* [KiKit](https://github.com/yaqwsx/KiKit) ⭐ 2,016 | 🐛 98 | 🌐 Python | 📅 2026-08-05: Library and CLI tool to panelize boards, export manufacturing data and build board presentation pages.
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,056 | 🐛 88 | 🌐 Python | 📅 2026-09-05: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,942 | 🐛 33 | 🌐 Java | 📅 2026-09-04: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,644 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,425 | 🐛 10 | 🌐 Python | 📅 2026-08-07: Convert your KiCAD boards into nice looking 2D drawings suitable for pinout diagrams
...
* [KiCad Templates](https://github.com/sethhillbrand/kicad_templates) ⭐ 766 | 🐛 6 | 🌐 HTML | 📅 2019-10-24: Provides a number of additional Board and production house templates for KiCad EDA.
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 736 | 🐛 27 | 🌐 Python | 📅 2026-09-04: KiCad automation utility.
...
* [Circuitron](https://github.com/Shaurya-Sethi/circuitron) ⭐ 122 | 🐛 8 | 🌐 Python | 📅 2026-06-06: Agentic PCB Design Accelerator — Generate, plan, and layout circuits from natural language prompts.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,553 | 🐛 43 | 🌐 Python | 📅 2026-09-02: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicanvas](https://github.com/theacodes/kicanvas) ⭐ 1,130 | 🐛 55 | 🌐 TypeScript | 📅 2026-04-28: KiCanvas is an interactive, browser-based viewer for KiCAD schematics and boards
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,110 | 🐛 1 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [KiCadStepUp](https://github.com/easyw/kicadStepUpMod/) ⭐ 686 | 🐛 39 | 🌐 Python | 📅 2026-09-04: KiCad StepUp is a FreeCAD Workbench to help in mechanical collaboration between KiCad EDA and FreeCAD.
...
* [gerber2ems](https://github.com/antmicro/gerber2ems) ⭐ 258 | 🐛 6 | 🌐 Python | 📅 2026-04-23: Takes PCB production files as input (Gerber, drill files, stackup information) and simulates trace SI performance using openEMS
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,950 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

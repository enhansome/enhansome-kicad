...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 603 | 🐛 0 | 🌐 Python | 📅 2026-08-25 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 603 | 🐛 0 | 🌐 Python | 📅 2026-08-25; you rock!
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,062 | 🐛 70 | 🌐 Python | 📅 2026-09-09: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,966 | 🐛 41 | 🌐 Java | 📅 2026-09-10: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,651 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 739 | 🐛 27 | 🌐 Python | 📅 2026-09-07: KiCad automation utility.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,563 | 🐛 43 | 🌐 Python | 📅 2026-09-10: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,172 | 🐛 2 | 🌐 Python | 📅 2026-09-01: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [gerber2ems](https://github.com/antmicro/gerber2ems) ⭐ 261 | 🐛 6 | 🌐 Python | 📅 2026-04-23: Takes PCB production files as input (Gerber, drill files, stackup information) and simulates trace SI performance using openEMS
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 90 | 🐛 2 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Keyboard PCB guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,953 | 🐛 22 | 📅 2024-07-02: Guide on how to design keyboard PCBs with KiCad

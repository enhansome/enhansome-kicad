...
Please take a quick gander at the [contribution guidelines](https://github.com/joanbono/awesome-kicad/blob/main/CONTRIBUTING.md) ⭐ 616 | 🐛 0 | 🌐 Python | 📅 2026-09-15 first. Thanks to all [contributors](https://github.com/joanbono/awesome-kicad/graphs/contributors) ⭐ 616 | 🐛 0 | 🌐 Python | 📅 2026-09-15; you rock!
...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,075 | 🐛 74 | 🌐 Python | 📅 2026-09-16: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 2,003 | 🐛 23 | 🌐 Java | 📅 2026-09-19: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,663 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiCad RF Tools](https://github.com/easyw/RF-tools-KiCAD) ⭐ 828 | 🐛 38 | 🌐 Python | 📅 2024-11-11: Footprints, wizards and round tracks, mask expander, via fencing
...
* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,268 | 🐛 2 | 🌐 Python | 📅 2026-09-13: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
...
* [gerber2ems](https://github.com/antmicro/gerber2ems) ⭐ 260 | 🐛 7 | 🌐 Python | 📅 2026-04-23: Takes PCB production files as input (Gerber, drill files, stackup information) and simulates trace SI performance using openEMS
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 96 | 🐛 2 | 🌐 Python | 📅 2026-09-16: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.

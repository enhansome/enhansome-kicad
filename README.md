...
* [Kicad JLCPCB Tools](https://github.com/Bouni/kicad-jlcpcb-tools) ⭐ 2,066 | 🐛 68 | 🌐 Python | 📅 2026-09-15: Plugin to generate all files necessary for JLCPCB board fabrication and assembly
...
* [FreeRouting](https://github.com/freerouting/freerouting) ⭐ 1,985 | 🐛 40 | 🌐 Java | 📅 2026-09-15: Advanced PCB auto-router
* [SKiDL](https://github.com/devbisme/skidl) ⭐ 1,657 | 🐛 46 | 🌐 Python | 📅 2026-08-20: A module that extends Python with the ability to design electronic circuits.
...
* [KiCad Templates](https://github.com/sethhillbrand/kicad_templates) ⭐ 770 | 🐛 6 | 🌐 HTML | 📅 2019-10-24: Provides a number of additional Board and production house templates for KiCad EDA.
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 740 | 🐛 25 | 🌐 Python | 📅 2026-09-11: KiCad automation utility.
...
* [KiBuzzard](https://github.com/gregdavill/KiBuzzard) ⭐ 470 | 🐛 25 | 🌐 Python | 📅 2026-04-09: Create labels in various fonts, and with inverted backgrounds
* [svg2mod](https://github.com/mtl/svg2mod) ⭐ 259 | 🐛 25 | 🌐 Python | 📅 2023-02-01: Convert Inkscape SVG drawings to KiCad footprint modules
* [Import-LIB-KiCad-Plugin](https://github.com/Steffen-W/Import-LIB-KiCad-Plugin) ⭐ 256 | 🐛 7 | 🌐 Python | 📅 2026-05-01: Import KiCad component libraries imported from Ultralibrarian and SnapEDA zipfiles.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,565 | 🐛 43 | 🌐 Python | 📅 2026-09-10: Generate convenient BOM listing with ability to visually correlate and easily search for components and their placements on the pcb

##### Reviewing

* [kicad-happy](https://github.com/aklofas/kicad-happy) ⭐ 1,213 | 🐛 2 | 🌐 Python | 📅 2026-09-13: AI-powered design review for KiCad — schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing prep via Claude Code skills.
* [kicanvas](https://github.com/theacodes/kicanvas) ⭐ 1,133 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-28: KiCanvas is an interactive, browser-based viewer for KiCAD schematics and boards
...
* [RFsim](https://github.com/NBalciunas/kicad-rfsim) ⭐ 95 | 🐛 2 | 🌐 Python | 📅 2026-09-02: KiCad 10 plugin for simulating S-parameters, E/H fields and far field of an RF structure directly in the PCB editor with the openEMS FDTD solver.
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 116 | 🐛 0 | 📅 2026-09-13: Curated list of open source hardware projects whose PCBs are designed in KiCad.
